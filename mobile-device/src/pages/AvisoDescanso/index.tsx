	...
	return (
		<View style={styles.container}>
			...
			<Text style={styles.esquecerText}>
				Você sabia? De acordo com a CLT o caminhoneiro deve fazer um intervalo de 30min a cada 6 horas de
				direção, sendo proibido dirigir por mais de 5 horas e meia sem nenhuma pausa.
			</Text>
