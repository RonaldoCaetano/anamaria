...
export default function App() {
	return (
		<View style={styles.container}>
            ...
            <Text style={styles.esquecerText}> Alimentos leves e naturais são as melhores escolhas para uma viagem tranqüila. Que tal escolher essa sugestão do Ponto de parada:</Text>
